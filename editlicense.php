                    ...
                    <section class="panel">
                        ...
                        <form role="form" id="frmEditLicense">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="txtDomain" class="form-control" value="<?php echo $data['host'];?>" placeholder="Domain Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control m-bot15" id="slcProduct">
                                    ...
                                    {?>
                                        <option value="<?php echo $row['id'];?>" <?php if($row['id'] == $data['productid']){echo 'selected';}?>><?php echo $row['shortname'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class="form-group">
