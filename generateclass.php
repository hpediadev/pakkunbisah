                        ...
                        <div class="panel-body">
                            ...
                            <?php }else{?>
                                <form role="form" id="frmGenerateClass">
                                    ...
                                    <div class="form-group">
                                        <label for="slcProduct">Product</label>
                                        <select class="form-control m-bot15" id="slcType">
                                            <option value="1">Host Name (Domain)</option>
                                            <option value="2">License Key</option>
                                        </select>
                                        <span class="help-block">Check the documentation for detailed instructions.</span>
                                    </div>
